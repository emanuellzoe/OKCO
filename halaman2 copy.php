...
<head>
    ...
    <script>
        ...
        quantityInputs.forEach(input => {
            input.addEventListener('change', function() {
                ...
                if (isNaN(quantity) || quantity < 1) {
                    alert('Jumlah tiket minimal 1, untuk melanjutkan ke halaman pembelian.');
                    this.value = ''; // Kosongkan nilai input jika tidak valid
                }
            });
        });
        ...
        beliTiketButtons.forEach(button => {
            button.addEventListener("click", function(event) {
                const type = button.closest(".beli-tiket2").getAttribute("data-type");
                const quantityInput = document.querySelector(`#quantity_${type.toLowerCase()}`);
                const quantity = parseInt(quantityInput.value);
                
                if (isNaN(quantity) || quantity < 1) {
                    event.preventDefault(); // Mencegah tindakan default jika input tidak valid
                    alert('Jumlah tiket minimal 1, untuk melanjutkan ke halaman pembelian.');
                } else {
                    // Lanjut ke halaman pembelian jika input valid
            ...
            document.querySelectorAll(".beli-tiket").forEach(button => {
                button.addEventListener("click", function() {
                    const input = this.nextElementSibling.nextElementSibling.querySelector("input[type='number']");
                    if (input) {
            ...
            document.querySelectorAll(".batal-tiket").forEach(button => {
                button.addEventListener("click", function() {
                ...
                <div class="border-tiktik">
                    <div class="tiktik">
                            ...
                            <div class="tiket-detail">
                                ...
                                <input class="number hidden" id="quantity_tribun" type="number" name="quantity_tribun" min="0" max="10">
                            </div>
                    </div>
                ...
                <div class="border-tiktik">
                    <div class="tiktik">
                            ...
                            <div class="tiket-detail">
                                ...
                                <input class="number hidden" id="quantity_festival" type="number" name="quantity_festival" min="0" max="10">
                            </div>
                    </div>
                ...
                <div class="border-tiktik">
                    <div class="tiktik">
                            ...
                            <div class="tiket-detail">
                                ...
                                <input class="number hidden" id="quantity_vip" type="number" name="quantity_vip" min="0" max="10">
                            </div>
                    </div>
...
document.addEventListener("DOMContentLoaded", function() {
    var hiddenInputs = document.querySelectorAll('.number.hidden');
